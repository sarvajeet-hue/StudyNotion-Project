              ...
              >
                {link.title === "Catalog" ? (
                  <div className="flex justify-center items-center relative group">
                    ...
                    <IoIosArrowDown />
                    <div
                      className="invisible opacity-0 z-[1000] flex absolute top-[70%] left-[10%] flex-col p-4 rounded-md bg-richblack-5 text-richblack-700 transition-all duration-200
                    ...
                    >
                      ...
                      {catalogData ? (
                        <div className="flex flex-col p-3 items-start  hover:visible">
                          {catalogData.allCategories.map((names, index) => {
                            return (
                              <Link key={index} to={"/python"}>
                                {" "}
                                {names.name}
                              </Link>
                            );
        ...
        {user ? (
          <div className="flex  justify-end items-center gap-5 text-richblack-5">
            ...
            <Dropdown
              ...
              className="bg-richblack-5 text-richblack-600 p-3 font-inter font-semibold gap-2 "
              arrowIcon={false}
              label={
                <div className="">
                  <img
