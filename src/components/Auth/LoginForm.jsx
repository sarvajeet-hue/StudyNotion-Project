...
import { GoogleLoginPlatform } from "../Google_Authentication/GoogleLoginPlatform";
        ...
        >
          <div className="flex flex-col gap-2 text-richblack-5">
            <label className="flex items-center gap-1" htmlFor="email">
              Email Address<sub className="text-pink-400">*</sub>
            </label>
            <input
              type="email"
          ...
          <div className="flex flex-col gap-2 text-richblack-5">
            <label className="flex items-center gap-1" htmlFor="password">
              Password <sub className="text-pink-400">*</sub>
            </label>
            <input
              type="password"
          ...
          <button className="flex p-3 justify-center items-center gap-2 rounded-lg bg-yellow-50 mt-4 ">
            Sign in
          </button>
        </form>
      </div>
