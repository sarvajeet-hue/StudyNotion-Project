...
import { GoogleSignup } from "../Google_Authentication/GoogleSignup";
  ...
  return (
    <div>
      ...
      <form
        ...
        className="flex w-full flex-col gap-4 text-richblue-5"
      >
      ...
      <div className="mt-6 flex justify-center items-center">
        {/* <button className='text-white rounded-full w-[40px] h-[40px] p-3 bg-white flex items-center justify-center'><FaGoogle className="w-8 h-8 text-blue-100 "  /></button> */}
