                ...
                <div className='w-[913px] h-[276px] flex flex-col items-center justify-between  text-white gap-[38px] mt-[124px] '>
                    <Link to={"/signup"}>
                        <div className=' group flex p-1 gap-1 items-start border rounded-[500px] bg-richblack-800 '>
                            <div className='flex justify-center items-center py-[6px] px-[18px] gap-[10px] border rounded-[100px] font-medium
                        group-hover:bg-richblack-900 '>
                                <p className='  text-richblack-200 text-base text-center leading-6'>Become an instructor</p>
